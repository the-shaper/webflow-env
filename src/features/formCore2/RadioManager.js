class RadioManager {
  ...
  setupEventDelegation() {
    document.addEventListener('click', (event) => {
      ...
      console.log('🎯 RadioManager2: Click Event', {
      ...
      console.log('🔄 RadioManager2: Handling Click', {
        radio: radio.name,
    ...
    document.addEventListener('change', (event) => {
      ...
      console.log('📻 RadioManager2: Change Event', {
  ...
  updateRadioVisualState(radio) {
    ...
    const formWrapper = radio.closest('[data-form="second"]')
    const groupRadios = formWrapper.querySelectorAll(
  ...
  handleMainRadioChange(radio) {
    console.log('⚡ RadioManager2: Handling Main Radio Change', {
      name: radio.name,
